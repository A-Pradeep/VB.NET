<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Approve_Cur.aspx.vb" Inherits="Bank_of_Swiss.Approve_Cur" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Select Current Account Requests</title>
      <meta charset="utf-8">
    ...
    <form id="form1" runat="server">
     <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1324px; top: 138px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
                <asp:Panel ID="Panel4" runat="server" 
        
        
        style="z-index: 1; left: 17px; top: 169px; position: absolute; height: 355px; width: 1292px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        ...
                        SelectCommand="SELECT [acno], [name], [occupation], [cellnum], [email], [address], [actype], [intracno], [status], [purl], [pname] FROM [client] WHERE (([actype] = @actype) AND ([status] = @status))">
            <SelectParameters>
                <asp:Parameter DefaultValue="Current Account" Name="actype" Type="String" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            style="z-index: 1; left: 14px; top: 21px; position: absolute; height: 292px; width: 983px" 
            DataKeyNames="acno" AllowSorting="True" BorderColor="#CC6600" PageSize="5" 
                        ToolTip="Current Account Requests">
            <Columns>
            ...
            <HeaderStyle BorderColor="#FF9900" BorderStyle="Solid" BorderWidth="1px" />
        </asp:GridView>
    </asp:Panel>
    <p>
        &nbsp;</p>
