<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cur_Money_transS.aspx.vb" Inherits="Bank_of_Swiss.Cur_Money_transS" %>
...
<body>
    ...
    <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1097px; top: 191px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
     <br />
           <br /> 
          <br /> 
