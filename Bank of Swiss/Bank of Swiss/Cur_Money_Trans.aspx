<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Cur_Money_Trans.aspx.vb" Inherits="Bank_of_Swiss.Cur_Money_Trans" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Current Account Money Transfer</title>
      <meta charset="utf-8">
...
<body>
    ...
    <asp:Panel ID="Panel5" runat="server" BorderColor="Black" BorderWidth="3px" 
                    ...
                    style="z-index: 1; left: 205px; top: 188px; position: absolute; height: 344px; width: 684px" 
                    BorderStyle="Double">
        ...
        <asp:Label ID="Label3" runat="server" 
            ...
            <asp:TextBox ID="TextBox1" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                ...
                ToolTip="Full Name" BorderColor="Black" TabIndex="1"></asp:TextBox>
            ...
            <asp:TextBox ID="TextBox3" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                ...
                TextMode="MultiLine" BorderColor="Black"></asp:TextBox>
            <asp:TextBox ID="TextBox2" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                ...
                ToolTip="Job / If Student specify it" BorderColor="Black" TabIndex="2"></asp:TextBox>
            ...
            <asp:DropDownList ID="DropDownList3" runat="server" 
                ...
                TabIndex="4" ToolTip="Select Type of Account">
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial Black" 
            ...
            style="z-index: 1; left: 146px; top: 257px; position: absolute; height: 25px; width: 323px; margin-bottom: 0px;" 
            Visible="False">Correct the Highlighted fields...!</asp:Label>
                    <asp:Label ID="Label14" runat="server" Font-Bold="True" 
                        ...
                        style="z-index: 1; left: 193px; top: 276px; position: absolute; height: 25px; width: 204px; margin-bottom: 0px;" 
                        Visible="False">Insufficient Fund...!</asp:Label>
                    <asp:TextBox ID="TextBox5" runat="server" 
                        
                        style="z-index: 1; left: 526px; top: 260px; position: absolute; height: 21px; width: 115px" 
                        Enabled="False" Visible="False"></asp:TextBox>
                    <asp:Label ID="Label17" runat="server" Font-Bold="True" 
                        Font-Names="Arial Black" Font-Size="Large" ForeColor="#FF3300" 
                        style="z-index: 1; left: 105px; top: 260px; position: absolute; height: 25px; width: 402px; margin-bottom: 0px;" 
                        Visible="False">Creadit to your Current Account First...!</asp:Label>
    </asp:Panel>
