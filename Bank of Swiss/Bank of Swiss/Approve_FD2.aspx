<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Approve_FD2.aspx.vb" Inherits="Bank_of_Swiss.Approve_FD2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Approve FD Requests</title>
         <meta charset="utf-8">
    ...
    <form id="form1" runat="server">
     <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1146px; top: 140px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
         ...
         style="z-index: 1; left: 78px; top: 144px; position: absolute; height: 448px; width: 1029px">
        ...
        <asp:Button ID="Button1" runat="server" 
                ...
                style="z-index: 1; left: 346px; top: 377px; position: absolute; height: 26px; width: 85px" 
                Text="Approve" ToolTip="Click to Approve Account" />
        <asp:Button ID="Button2" runat="server" 
            style="z-index: 1; left: 129px; top: 377px; position: absolute; height: 26px; width: 85px" 
            TabIndex="11" Text="Back" ToolTip="Back to Selection" 
                PostBackUrl="~/Approve_FD.aspx" />
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial Black" 
            ...
            style="z-index: 1; left: 131px; top: 416px; position: absolute; height: 25px; width: 323px; margin-bottom: 0px;" 
            Visible="False">Correct the Highlighted fields...!</asp:Label>
        <asp:Label ID="Label12" runat="server" Font-Bold="True" 
            Font-Names="Arial Black" Font-Size="Large" ForeColor="#00CC00" 
            style="z-index: 1; left: 228px; top: 414px; position: absolute; height: 25px; width: 110px; margin-bottom: 0px;" 
        ...
        <asp:Label ID="Label13" runat="server" 
            ...
            <asp:Panel ID="Panel8" runat="server" BackColor="#99CCFF" BorderColor="Yellow" 
                BorderStyle="Outset" BorderWidth="2px" 
                        ...
                        style="z-index: 1; left: 742px; top: 52px; position: absolute; height: 242px; width: 250px">
