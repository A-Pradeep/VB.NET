...
Public Class Cur_Money_Trans
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        End If
        Conn.Open()
        Dim cmd2 As New SqlCommand("select sum(balance) from currentac where acno='" & Label16.Text & "' group by acno ", Conn)
        ...
        If res2.HasRows = True Then
            ...
            Dim cmd3 As New SqlCommand("update currentac set deposit='0.00',withdraw='" & TextBox2.Text & "',date='" & TextBox6.Text & "',balance='" & TextBox5.Text & "' ,particulars='" & TextBox3.Text & "'", Conn)
            ...
            Conn.Close()
            Response.Redirect("Cur_Money_TransS.aspx")
            Exit Sub
        Else
