<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Admin_FD_With.aspx.vb" Inherits="Bank_of_Swiss.Admin_FD_With1" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FD Withdraw</title>
    <meta charset="utf-8">
...
<body>
 ...
 <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1183px; top: 146px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
                <asp:Panel ID="Panel4" runat="server" 
        
        
        style="z-index: 1; left: 61px; top: 186px; position: absolute; height: 358px; width: 921px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                        ...
                        SelectCommand="SELECT * FROM [fdac] WHERE ([m_date] &lt;= @m_date) ORDER BY [acno]">
            <SelectParameters>
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            Caption="Approval List" DataSourceID="SqlDataSource1" 
                        ...
                        AllowSorting="True" BorderColor="#CC6600" PageSize="5">
            <Columns>
                <asp:CommandField ShowSelectButton="True" />
                <asp:BoundField DataField="acno" HeaderText="acno" SortExpression="acno" />
                <asp:BoundField DataField="d_amt" HeaderText="d_amt" SortExpression="d_amt" />
    ...
    <asp:TextBox ID="TextBox1" runat="server" Enabled="False" 
        ...
        style="z-index: 1; left: 959px; top: 138px; position: absolute; height: 23px; width: 125px"></asp:TextBox>
    <asp:Label ID="Label2" runat="server" 
        style="z-index: 1; left: 908px; top: 138px; position: absolute; height: 21px; width: 57px" 
        Text="Date"></asp:Label>
    ...
    <marquee behavior="alternate" scrollamount="3">If no records found then there is no Matured FD Accounts for Withdrawal...!</marquee>
    </div>
     <br /><br /><br /><br /><br /><br />
        <br /><br /><br /><br /><br /><br />
        <br /><br /><br /><br /><br /><br />
