<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Approve_RD2.aspx.vb" Inherits="Bank_of_Swiss.Approve_RD2" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Approve Selected RD Requests</title>
     <meta charset="utf-8">
    ...
    <form id="form1" runat="server">
     <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1167px; top: 143px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
         ...
         style="z-index: 1; left: 109px; top: 146px; position: absolute; height: 449px; width: 1028px">
        ...
        <asp:Button ID="Button1" runat="server" 
                ...
                style="z-index: 1; left: 359px; top: 384px; position: absolute; height: 26px; width: 85px" 
                Text="Approve" ToolTip="Click to Approve Account" />
        <asp:Button ID="Button2" runat="server" 
            style="z-index: 1; left: 134px; top: 383px; position: absolute; height: 26px; width: 85px" 
            TabIndex="11" Text="Back" ToolTip="Back to Selection" 
                PostBackUrl="~/Approve_RD.aspx" />
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial Black" 
            ...
            style="z-index: 1; left: 128px; top: 420px; position: absolute; height: 25px; width: 323px; margin-bottom: 0px;" 
            Visible="False">Correct the Highlighted fields...!</asp:Label>
        <asp:Label ID="Label12" runat="server" Font-Bold="True" 
            Font-Names="Arial Black" Font-Size="Large" ForeColor="#00CC00" 
            style="z-index: 1; left: 236px; top: 420px; position: absolute; height: 25px; width: 110px; margin-bottom: 0px;" 
        ...
        <asp:Label ID="Label13" runat="server" 
            ...
            <asp:Panel ID="Panel8" runat="server" BackColor="#99CCFF" BorderColor="Yellow" 
                BorderStyle="Outset" BorderWidth="2px" 
                        ...
                        style="z-index: 1; left: 742px; top: 52px; position: absolute; height: 239px; width: 248px">
