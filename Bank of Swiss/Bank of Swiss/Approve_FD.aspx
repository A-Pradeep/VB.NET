<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Approve_FD.aspx.vb" Inherits="Bank_of_Swiss.Approve_FD" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Select FD Requests</title>
      <meta charset="utf-8">
...
<body>
   ...
   <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1202px; top: 146px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
    ...
    <asp:Panel ID="Panel4" runat="server" 
        ...
        style="z-index: 1; left: 63px; top: 162px; position: absolute; height: 358px; width: 1103px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Fixed Deposit (FD)" Name="actype" Type="String" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            style="z-index: 1; left: 14px; top: 21px; position: absolute; height: 294px; width: 1008px" 
