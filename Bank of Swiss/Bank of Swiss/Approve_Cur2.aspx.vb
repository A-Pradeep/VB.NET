...
Public Class Approve_Cur2
    ...
    Protected Sub Button1_Click(ByVal sender As Object, ByVal e As EventArgs) Handles Button1.Click
        ...
        Try
            ...
            mail.Body = "This mail was sent as you had requested to open an account with Bank of Swiss,and it is been Approved by our Experts...! User Id : '" & TextBox6.Text & "' and Password : 'Abc123' Please change the password when you read this email...! "
