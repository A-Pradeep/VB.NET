<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Admin_FD_Dep.aspx.vb" Inherits="Bank_of_Swiss.Admin_FD_Dep" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>FD Deposit</title>
    <meta charset="utf-8">
...
<body>
   ...
   <header>
        ...
        Text="FD Cash Deposit"></asp:Label>
        ...
        style="z-index: 1; left: 213px; top: 169px; position: absolute; height: 470px; width: 684px">
        <asp:Panel ID="Panel6" runat="server" BackColor="#99CCFF" 
            ...
            <asp:Label ID="Label3" runat="server" 
                style="z-index: 1; left: 13px; top: 20px; position: absolute; height: 20px; width: 102px;" 
                Text="Enter A/c num"></asp:Label>
            <asp:TextBox ID="TextBox7" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                style="z-index: 1; left: 119px; top: 20px; position: absolute" 
        ...
        <asp:Panel ID="Panel7" runat="server" BackColor="#99CCFF" 
                ...
                style="z-index: 1; left: 14px; top: 188px; position: absolute; height: 197px; width: 651px">
            <asp:Label ID="Label9" runat="server" 
                style="z-index: 1; left: 30px; top: 132px; position: absolute; width: 66px; height: 21px;" 
            ...
            <asp:TextBox ID="TextBox2" runat="server" BorderColor="Black" 
                ...
                style="z-index: 1; left: 140px; top: 116px; position: absolute; height: 49px; width: 355px" 
                TextMode="MultiLine" TabIndex="6" ToolTip="Deposit Summary"></asp:TextBox>
            <asp:Label ID="Label19" runat="server" 
                style="z-index: 1; left: 31px; top: 62px; position: absolute; height: 26px; width: 77px; right: 543px;" 
                Text="Rate (%)"></asp:Label>
            <asp:TextBox ID="TextBox9" runat="server" BorderColor="Black" 
                BorderStyle="Solid" BorderWidth="1px" MaxLength="6" 
                style="z-index: 1; left: 143px; top: 61px; position: absolute; height: 23px;" 
        ...
        <asp:Button ID="Button1" runat="server" 
            style="z-index: 1; left: 422px; top: 399px; position: absolute; width: 85px" 
            TabIndex="7" Text="Deposit" ToolTip="Click to Deposit " />
        <asp:Button ID="Button2" runat="server" 
            style="z-index: 1; left: 137px; top: 396px; position: absolute; height: 26px; width: 85px" 
            TabIndex="9" Text="Back" ToolTip="Click to go Back" 
        ...
        <asp:Label ID="Label2" runat="server" Font-Bold="True" Font-Names="Arial Black" 
            ...
            style="z-index: 1; left: 155px; top: 433px; position: absolute; height: 25px; width: 323px; margin-bottom: 0px;" 
            Visible="False">Correct the Highlighted fields...!</asp:Label>
        <asp:Button ID="Button3" runat="server" 
            style="z-index: 1; left: 269px; top: 397px; position: absolute; height: 26px; width: 85px" 
            TabIndex="8" Text="Clear" ToolTip="Click to Clear" />
            <asp:Label ID="Label12" runat="server" Font-Bold="True" 
                Font-Names="Arial Black" Font-Size="Large" ForeColor="#00CC00" 
                style="z-index: 1; left: 189px; top: 432px; position: absolute; height: 25px; width: 258px; margin-bottom: 0px;" 
    ...
    <asp:Panel ID="Panel8" runat="server" BackColor="#FFCCFF" BorderColor="#E1E100" 
        ...
        style="z-index: 1; left: 363px; top: 270px; position: absolute; height: 277px; width: 379px">
        <asp:Label ID="Label20" runat="server" 
    
            style="z-index: 1; left: 110px; top: 18px; position: absolute; height: 25px; width: 148px;" 
        ...
        <asp:Panel ID="Panel9" runat="server" BackColor="#FFCCFF" BorderStyle="Double" 
            ...
            <asp:Label ID="Label22" runat="server" ForeColor="#006600" 
                style="z-index: 1; left: 30px; top: 7px; position: absolute; height: 25px; width: 93px; right: 212px;" 
                Text="Amount"></asp:Label>
            <asp:Label ID="Label23" runat="server" 
                style="z-index: 1; left: 170px; top: 8px; position: absolute; height: 22px; width: 122px" 
        ...
        <asp:Panel ID="Panel10" runat="server" BackColor="#FFCCFF" BorderStyle="Double" 
            ...
            <asp:Label ID="Label26" runat="server" ForeColor="#006600" 
                style="z-index: 1; left: 15px; top: 7px; position: absolute; height: 25px; width: 93px" 
                Text="Maturity On"></asp:Label>
            <asp:Label ID="Label29" runat="server" 
                style="z-index: 1; left: 172px; top: 10px; position: absolute; height: 22px; width: 122px" 
                Text="Label"></asp:Label>
        </asp:Panel>
        <asp:Panel ID="Panel11" runat="server" BackColor="#FFCCFF" BorderStyle="Double" 
            ...
            <asp:Label ID="Label27" runat="server" ForeColor="#006600" 
                style="z-index: 1; left: 21px; top: 6px; position: absolute; height: 25px; width: 101px" 
                Text="Yield Amount"></asp:Label>
            <asp:Label ID="Label28" runat="server" 
                style="z-index: 1; left: 173px; top: 9px; position: absolute; height: 22px; width: 122px" 
                Text="Label"></asp:Label>
        </asp:Panel>
        <asp:Panel ID="Panel12" runat="server" BackColor="#FFCCFF" BorderStyle="Double" 
            ...
            <asp:Label ID="Label24" runat="server" ForeColor="#006600" 
                style="z-index: 1; left: 15px; top: 6px; position: absolute; height: 25px; width: 101px" 
                Text="Total Earning"></asp:Label>
    ...
    <p>
        <asp:Label ID="Label21" runat="server" Font-Bold="True" Font-Names="Arial Black" 
            Font-Size="Large" ForeColor="#FF3300" 
            style="z-index: 1; left: 417px; top: 322px; position: absolute; height: 25px; width: 323px; margin-bottom: 0px;" 
            Visible="False">You are having a FD Account...!</asp:Label>
        </p>
        <br /><br /><br /><br /><br /><br />
        <br /><br /><br /><br /><br /><br />
        <br /><br /><br /><br /><br /><br />
