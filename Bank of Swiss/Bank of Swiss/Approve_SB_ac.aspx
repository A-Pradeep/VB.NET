<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Approve_SB_ac.aspx.vb" Inherits="Bank_of_Swiss.Approve_RD_" %>

<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Select SB Account Requests</title>
     <meta charset="utf-8">
...
<body>
    <form id="form1" runat="server">
      <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1342px; top: 131px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
    ...
    <asp:Panel ID="Panel4" runat="server" 
        ...
        style="z-index: 1; left: 34px; top: 161px; position: absolute; height: 358px; width: 1292px" 
        ...
        <asp:SqlDataSource ID="SqlDataSource1" runat="server" 
            ...
            <SelectParameters>
                <asp:Parameter DefaultValue="Saving Bank (SB)" Name="actype" Type="String" />
        ...
        <asp:GridView ID="GridView1" runat="server" AllowPaging="True" 
            ...
            style="z-index: 1; left: 14px; top: 21px; position: absolute; height: 298px; width: 1012px" 
            DataKeyNames="acno" AllowSorting="True" BorderColor="#FF9900" PageSize="5">
            <Columns>
