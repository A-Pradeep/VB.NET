<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="Admin_RD_With2.aspx.vb" Inherits="Bank_of_Swiss.Admin_RD_With2" %>
...
<body>
    ...
    <header>
        ...
        <asp:ImageButton ID="ImageButton8" runat="server" 
            ...
            style="z-index: 1; left: 1071px; top: 136px; position: absolute; height: 61px; width: 61px" 
            ToolTip="Log Out" />
        ...
        style="z-index: 1; left: 290px; top: 141px; position: absolute; height: 468px; width: 679px">
        <asp:Panel ID="Panel6" runat="server" BackColor="#99CCFF" 
            ...
            <asp:Label ID="Label4" runat="server" 
                style="z-index: 1; left: 258px; top: 23px; position: absolute; height: 17px; width: 100px;" 
            ...
            <asp:TextBox ID="TextBox3" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                ...
                style="z-index: 1; left: 365px; top: 75px; position: absolute; height: 20px;" TabIndex="3" 
                ToolTip="Date" Enabled="False"></asp:TextBox>
            ...
            <asp:Label ID="Label7" runat="server" 
                style="z-index: 1; left: 281px; top: 73px; position: absolute; height: 20px; width: 38px;" 
                Text="Date"></asp:Label>
            ...
            <asp:TextBox ID="TextBox9" runat="server" BorderStyle="Solid" BorderWidth="1px" 
                Enabled="False" style="z-index: 1; left: 367px; top: 22px; position: absolute" 
                ToolTip="Full Name"></asp:TextBox>
            <asp:TextBox ID="TextBox10" runat="server" BorderStyle="Solid" 
                BorderWidth="1px" Enabled="False" 
                style="z-index: 1; left: 365px; top: 133px; position: absolute; height: 20px;" 
                ToolTip="Email ID" Visible="False"></asp:TextBox>
        </asp:Panel>
        ...
        <asp:Button ID="Button2" runat="server" 
            ...
            TabIndex="3" Text="Back" ToolTip="Back to Selection" 
                PostBackUrl="~/Admin_RD_With.aspx" />
        ...
        <asp:Label ID="Label12" runat="server" Font-Bold="True" 
            ...
            style="z-index: 1; left: 199px; top: 439px; position: absolute; height: 25px; width: 219px; margin-bottom: 0px;" 
